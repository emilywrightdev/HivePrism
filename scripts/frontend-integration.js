 ...
 * This file demonstrates how to integrate Hiveprism with a web frontend
 */

// For React/Vue/Angular applications
export class HiveprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HiveprismClient(provider, contractAddress);
